  ...
  const ALL_FEATURE_GROUPS = [
    {
      ...
      items: [
        ...
        {
          id: 'map',
          nameHi: 'NER लाइव GPS मानचित्र',
          nameEn: 'NER LIVE GPS MAP',
          descHi: '8 राज्यों का लाइव सैटेलाइट GIS नक्शा एवं GPS टेलीमेट्री',
          descEn: '8-State Live Satellite GIS Map & GPS Telemetry',
          icon: MapPin,
