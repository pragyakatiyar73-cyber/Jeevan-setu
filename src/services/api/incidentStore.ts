...
// Initial Incident Database (Strictly North-Eastern Region of India)
const INITIAL_INCIDENTS: DisasterIncident[] = [
  ...
  {
    id: 'JS-2026-004',
    title: 'Papum Pare Hill Slope Erosion Grid',
    disasterType: 'Landslide & Cloudburst',
    state: 'Arunachal Pradesh',
    district: 'Papum Pare',
    locationName: 'Itanagar Highway Ridge, Arunachal Pradesh',
    lat: 27.0844,
    lon: 93.6053,
    severity: 'HIGH',
    confidenceScore: 91,
    affectedAreaSqKm: 110.2,
    affectedPopulation: 11200,
    infrastructureRisk: 'NH-415 Highway Embankment Structural Slippage',
    roadRiskStatus: 'NH-415 CAUTION • ALTERNATE HILL BYPASS OPEN',
    timestamp: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }),
    source: 'Arunachal SDMA + Geological Survey of India Telemetry',
    dataStatus: 'LIVE DATA',
    priorityLevel: 'HIGH',
    priorityReason: 'Hill slope slipping near NH-415 + high precipitation forecast.',
    keyRiskFactors: ['11,200 People Affected', 'NH-415 Slope Instability', 'Hill Torrent Surge'],
    requiredResourceCategories: ['🚑 SDRF Slope Rescue', '🏗️ Excavator Units', '📦 Emergency Provisions'],
    recommendedRoute: 'Chimp-Hollongi Bypass Arterial',
    responseStatus: 'TEAM_ASSIGNED',
    statusUpdatedBy: 'Itanagar Emergency Control Room',
    statusUpdatedAt: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }),
    forecast72h: {
      period0_24h: { risk: 'HIGH', conditions: 'Torrential downpour 35 mm/hr', threat: 'Flash debris flow across NH-415', action: 'Position BRO earthmovers at vulnerable curves' },
      period24_48h: { risk: 'MEDIUM', conditions: 'Rain tapering to 12 mm/hr', threat: 'Loose rocks falling', action: 'Enforce single-lane regulated convoy traffic' },
      period48_72h: { risk: 'LOW', conditions: 'Clear skies', threat: 'Road debris clearance', action: 'Inspect retaining walls' }
    },
    activeSosCount: 4,
    rescueTeamsAssigned: 2,
    uavUnitsDispatched: 2,
    reliefeCampsActive: 2,
    overallRecoveryPercent: 48
  },
  {
    id: 'JS-2026-005',
    title: 'Imphal River Basin Water Elevation',
    disasterType: 'Flash Flood',
    state: 'Manipur',
    district: 'Imphal West',
    locationName: 'Imphal Valley Lowlands, Manipur',
    lat: 24.8170,
    lon: 93.9368,
    severity: 'MEDIUM',
    confidenceScore: 89,
    affectedAreaSqKm: 78.4,
    affectedPopulation: 16800,
    infrastructureRisk: 'Nambul & Imphal River Embankment Overflow Warning',
    roadRiskStatus: 'RIMS Road Clear • Minuthong Bridge Water Level Near Danger Mark',
    timestamp: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }),
    source: 'Manipur Water Resources Dept + Satellite Mesh',
    dataStatus: 'VERIFIED DATA',
    priorityLevel: 'MEDIUM',
    priorityReason: 'River water level 0.4m above warning level; embankment monitoring active.',
    keyRiskFactors: ['16,800 People Affected', 'Imphal River Level +0.4m', 'Lowland Inundation'],
    requiredResourceCategories: ['🛶 Inflatable Rescue Boats', '📦 Ration Distribution', '💧 Water Tanks'],
    recommendedRoute: 'Ring Road Bypass North',
    responseStatus: 'RESOURCE_RECOMMENDED',
    statusUpdatedBy: 'Manipur EOC Imphal',
    statusUpdatedAt: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }),
    forecast72h: {
      period0_24h: { risk: 'MEDIUM', conditions: 'River flow elevated at danger mark', threat: 'Inundation of low-lying agricultural pockets', action: 'Alert valley quick response teams' },
      period24_48h: { risk: 'MEDIUM', conditions: 'Slight recession expected', threat: 'Water stagnation', action: 'Deploy health squads for water testing' },
      period48_72h: { risk: 'LOW', conditions: 'Normal river stage', threat: 'Post-flood mud clearance', action: 'Disinfect flooded residential yards' }
    },
    activeSosCount: 3,
    rescueTeamsAssigned: 1,
    uavUnitsDispatched: 1,
    reliefeCampsActive: 2,
    overallRecoveryPercent: 62
  },
  {
    id: 'JS-2026-006',
    title: 'Aizawl Ridge Mudslide & Road Cut',
    disasterType: 'Landslide & Cloudburst',
    state: 'Mizoram',
    district: 'Aizawl',
    locationName: 'Zemabawk Corridor, Aizawl, Mizoram',
    lat: 23.7271,
    lon: 92.7176,
    severity: 'HIGH',
    confidenceScore: 94,
    affectedAreaSqKm: 54.0,
    affectedPopulation: 7600,
    infrastructureRisk: 'NH-54 Zemabawk Cut-off Point (Rockfall Blockade)',
    roadRiskStatus: 'NH-54 BLOCKED • LUNGLEI ROAD OPEN WITH CAUTION',
    timestamp: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }),
    source: 'Mizoram State Disaster Management Authority',
    dataStatus: 'LIVE DATA',
    priorityLevel: 'HIGH',
    priorityReason: 'NH-54 essential lifeline blocked by 200m rockfall; supply chain rerouted.',
    keyRiskFactors: ['7,600 People Affected', 'NH-54 Lifeline Cut-off', 'High Slope Angle'],
    requiredResourceCategories: ['🚜 Heavy Earthmovers', '🚑 Medical Triage Units', '📦 Food Packs'],
    recommendedRoute: 'Sairang Valley Alternate Route',
    responseStatus: 'TEAM_ASSIGNED',
    statusUpdatedBy: 'Aizawl District Disaster Management Authority',
    statusUpdatedAt: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }),
    forecast72h: {
      period0_24h: { risk: 'HIGH', conditions: 'Continuous monsoon drizzle', threat: 'Further boulder rolling on NH-54', action: 'Clear single track for emergency ambulances' },
      period24_48h: { risk: 'HIGH', conditions: 'Soil saturation peak', threat: 'Subsidence along slope base', action: 'Construct temporary retaining gabions' },
      period48_72h: { risk: 'MEDIUM', conditions: 'Weather improvement', threat: 'Traffic bottlenecking', action: 'Restore full commercial traffic flow' }
    },
    activeSosCount: 5,
    rescueTeamsAssigned: 2,
    uavUnitsDispatched: 2,
    reliefeCampsActive: 1,
    overallRecoveryPercent: 39
  },
  {
    id: 'JS-2026-007',
    title: 'Kohima Lifeline Corridor Mudslide',
    disasterType: 'Landslide & Cloudburst',
    state: 'Nagaland',
    district: 'Kohima',
    locationName: 'Phesama Ridge Sector, Kohima, Nagaland',
    lat: 25.6751,
    lon: 94.1086,
    severity: 'HIGH',
    confidenceScore: 93,
    affectedAreaSqKm: 82.3,
    affectedPopulation: 8900,
    infrastructureRisk: 'NH-2 Dimapur-Kohima Highway Sinking Zone (Km 45)',
    roadRiskStatus: 'NH-2 ONE-WAY HEAVY VEHICLES • PEDESTRIAN OVERPASS SECURE',
    timestamp: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }),
    source: 'Nagaland SDMA + BRO Project Sewak',
    dataStatus: 'VERIFIED DATA',
    priorityLevel: 'HIGH',
    priorityReason: 'NH-2 sinking zone movement detected; BRO engineers on site.',
    keyRiskFactors: ['8,900 People Affected', 'NH-2 Sinking Soil Zone', 'High Freight Delay'],
    requiredResourceCategories: ['👷 BRO Engineering Crew', '🚑 SDRF First Responders', '💧 Clean Water'],
    recommendedRoute: 'Peducha-Tsutuonuomia Bypass',
    responseStatus: 'EN_ROUTE',
    statusUpdatedBy: 'Kohima EOC Command',
    statusUpdatedAt: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }),
    forecast72h: {
      period0_24h: { risk: 'HIGH', conditions: 'Intermittent heavy showers', threat: 'Sub-surface soil creep at Km 45', action: 'Deploy Project Sewak heavy ballast trucks' },
      period24_48h: { risk: 'MEDIUM', conditions: 'Rainfall reducing', threat: 'Slow freight movement', action: 'Regulate night traffic' },
      period48_72h: { risk: 'LOW', conditions: 'Stable soil moisture', threat: 'Debris clear-up', action: 'Finalize road resurfacing schedule' }
    },
    activeSosCount: 4,
    rescueTeamsAssigned: 2,
    uavUnitsDispatched: 1,
    reliefeCampsActive: 2,
    overallRecoveryPercent: 51
  },
  {
    id: 'JS-2026-008',
    title: 'Howrah River Basin Inundation',
    disasterType: 'Flash Flood',
    state: 'Tripura',
    district: 'West Tripura',
    locationName: 'Agartala Sub-Urban Lowlands, Tripura',
    lat: 23.8315,
    lon: 91.2868,
    severity: 'MEDIUM',
    confidenceScore: 90,
    affectedAreaSqKm: 61.5,
    affectedPopulation: 12400,
    infrastructureRisk: 'Howrah River Embankment Water Pressure High',
    roadRiskStatus: 'Agartala Bypass Open • College Tilla Road Waterlogged',
    timestamp: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }),
    source: 'Tripura State Disaster Management Authority',
    dataStatus: 'VERIFIED DATA',
    priorityLevel: 'MEDIUM',
    priorityReason: 'Howrah river water level approaching warning mark in municipal sector.',
    keyRiskFactors: ['12,400 People Affected', 'Howrah River High Level', 'Urban Drainage Congestion'],
    requiredResourceCategories: ['🚒 High-Capacity Dewatering Pumps', '📦 Food Packs', '🏥 Medical Teams'],
    recommendedRoute: 'National Highway 8 Eastern Bypass',
    responseStatus: 'VERIFIED',
    statusUpdatedBy: 'Agartala EOC Command',
    statusUpdatedAt: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }),
    forecast72h: {
      period0_24h: { risk: 'MEDIUM', conditions: 'Moderate rainfall 22 mm/hr', threat: 'Water accumulation in municipal wards 12-16', action: 'Operate all 14 municipal pump stations' },
      period24_48h: { risk: 'MEDIUM', conditions: 'Water level plateauing', threat: 'Drinking water contamination', action: 'Deploy Mobile Water Purification Units' },
      period48_72h: { risk: 'LOW', conditions: 'Clear weather pattern', threat: 'Sludge accumulation', action: 'Sanitation drive in affected wards' }
    },
    activeSosCount: 2,
    rescueTeamsAssigned: 1,
    uavUnitsDispatched: 1,
    reliefeCampsActive: 1,
    overallRecoveryPercent: 68
  }
];
