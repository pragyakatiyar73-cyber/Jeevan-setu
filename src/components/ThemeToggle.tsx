...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className={`relative inline-flex shrink-0 items-center gap-1.5 rounded-full px-3.5 py-1.5 text-xs font-bold transition-all duration-300 transform hover:-translate-y-0.5 hover:scale-[1.08] hover:shadow-lg shadow-md cursor-pointer border focus:outline-none z-50 ${
        theme === 'dark'
