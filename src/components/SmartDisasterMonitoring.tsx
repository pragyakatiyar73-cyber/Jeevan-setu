      ...
      <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-gradient-to-r from-white via-slate-50 to-white dark:from-slate-900 dark:via-rose-950/30 dark:to-slate-900 p-5 shadow-xl dark:shadow-2xl flex flex-col lg:flex-row lg:items-center justify-between gap-4 transition-colors duration-300">
        <div>
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <span className="text-xs text-slate-400">{t("smartmonitoring.continuousTracking", "Continuous 72-Hour Situation Tracking")}</span>
          </div>
          ...
          <div className="mt-1 flex items-center gap-4 text-xs font-mono text-slate-400 flex-wrap">
            <span>{t("smartmonitoring.latitude", "Latitude:")} <b className="text-white">{monitoredLoc.lat.toFixed(4)}° N</b></span>
            <span>{t("smartmonitoring.longitude", "Longitude:")} <b className="text-white">{monitoredLoc.lon.toFixed(4)}° E</b></span>
            <span>{t("smartmonitoring.stateLabel", "State:")} <b className="text-slate-200">{monitoredLoc.state || 'NER Sector'}</b></span>
            <span>{t("smartmonitoring.lastSync", "Last Telemetry Sync:")} <b className="text-emerald-400">{reportTime}</b></span>
          </div>
        </div>
